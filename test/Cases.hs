...
dispatches =
  testGroup
    ...
    [ runDispatchTest "basic.solc",
      ...
      runDispatchTest "inheritance.solc",
      runDispatchTest "implements_owner.solc",
      runDispatchTest "inherits_counter.solc",
      runDispatchTest "super_update.solc",
      ...
      runDispatchTest "storage_struct.solc",
