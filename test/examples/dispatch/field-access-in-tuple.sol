...
//
// This is the minimal shape of the original deposit.sol failure
...
contract C {
    ...
    function encFields() public returns (memory<bytes>) {
    ...
    function encIndexed(i: uint256) public returns (memory<bytes>) {
