...
import Solcore.Frontend.Syntax.Location (NodeLocation (..), NodeOrigin (..))
...
-- Source locations (carried throughout the AST on current main) -------------
deriving stock instance Generic SourceSpan

deriving anyclass instance Binary SourceSpan

deriving stock instance Generic NodeOrigin

deriving anyclass instance Binary NodeOrigin

deriving stock instance Generic NodeLocation

deriving anyclass instance Binary NodeLocation
