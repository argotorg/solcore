...
$\Theta^{ins} = [C \mapsto \{\forall a,b.\,\{C\: a\: b\} \Rightarrow C\:(T^2\:
a)\: b \}$ and try to compute the set of satisfiable instances for $\pi = C\:a\: (T\:a)$ 
em rela\c{c}\~ao a $\Theta$.
Temos que $\pi$ unifica com a cabe\c{c}a da inst\^ancia $\forall
a,b.\:(C\: a\: b)\: \Rightarrow\: C\: (T^2\: a)\: b$, produzindo a
substitui\c{c}\~ao $S= [a \mapsto T^2\:a_1,\, b_1 \mapsto T^3\:a_1]$. Ent\~ao
deve-se computar recursivamente a satisfazibilidade de
$S(C\:a_1\:b_1) = C\:a_1\:(T^3\:a_1)$.  Mas este tamb\'em unifica com
$\forall a,b.\,(C\: a\: b) \Rightarrow C\: (T^2\:
a)\:b$, produzindo $S_1= [a_1 \mapsto (T^2\:a_2), b_2 \mapsto
  (T^3 a_1 = T^5\:a_2)]$. Ent\~ao, novamente, devemos computar a
satisfazibilidade de $S_1(C\:a_2\:b_2) = C\:a_2\:(T^5\:a_2)$, repetindo todo o processo e
ocasionando a n\~ao termina\c{c}\~ao.
\
\end{Example}
