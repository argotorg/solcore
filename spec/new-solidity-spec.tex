...
%   \[ \infer[^\texttt{SInst}]
%        	{\Theta \sats A\,a\,b  \leadsto \mathbb{S}_0 }
%        	{\begin{array}{l}
% 	      \Delta_0 = \{ (S_1, \emptyset, A\,\Int\,\tylist\Int),
%                             (S_2, \emptyset, A\,\Int\,\,\tylist\Bool) \} \vspace{.1cm} \\
% 	      \mathbb{S}_0 = \left\{ S'S \,\left\vert\,(S,Q,\pi') \in \Delta_0,\,
% 													 S' \in \mathbb{S}',
%                                  					\Theta \sats Q \leadsto \mathbb{S}'
% 													\right. \right\} \\
% 	\end{array}}
%   \]
% onde $S_1=[a \mapsto \Int,\, b\mapsto \tylist\Int]$,
%       $S_2=[a \mapsto \Int,\, b\mapsto \tylist\Bool]$.
%
% Pela regra \texttt{SConj}, o conjunto de substitui\c{c}\~oes para
% $S_1(D\:b)= D\,\tylist\Int$ and $S_2(D\:b)= D\,\tylist\Bool$
% \'e dado por:
%   \[ \infer[^\texttt{SInst}]
%        	{\Theta \sats D\,\tylist\Int \leadsto \mathbb{S}_1^1}
%        	{\begin{array}{ll}
% 	      \Delta_1 = \{ (S_1'|_\emptyset, \{C\,\Int\}, D\,\tylist b) \} &\vspace{.1cm} \\
% 	      \mathbb{S}_1^1 = \left\{ S'S \,\left\vert\,(S,Q,\pi') \in \Delta_1,\, S' \in \mathbb{S}',\Theta \sats Q \leadsto \mathbb{S}'
% 													  \right.
% 									\right\} \\
% 	\end{array}}
%   \]
%   onde $S_1' = [b_1\mapsto \Int]$, $b_1$ \'e uma nova vari\'avel, $S_1'|_\emptyset = \id$, e
%   \[ \infer[^\texttt{ SInst}]
%        	{\Theta \sats D\,\tylist\Bool] \leadsto \mathbb{S}_1^2 }
%        	{\begin{array}{l}
% 	      \Delta_2 = \{ (S_2'|_\emptyset, \{ C\,\Bool\}, D\,\,\tylist b) \} \vspace{.1cm} \\
% 	      \mathbb{S}_1^2 = \left\{
% 									S'S \,\left\vert\, (S,Q,\pi') \in \Delta_2,
% 															 S' \in \mathbb{S}',
% 					  					                    \Theta \sats Q \leadsto \mathbb{S}'
% 												\right .
% 								\right\}
% 	\end{array}}
%   \]
% onde $S_2' = [b_2\mapsto \Bool]$, $b_2$ \'e uma nova vari\'avel,
% $S_2'|_\emptyset = \id$.  Now, $\mathbb{S}_1^1 = \{ \id \}$ and $\mathbb{S}_1^2 =
% \emptyset$.  Assim, temos que $\mathbb{S} = \{S_1\}$.
\end{Example}
